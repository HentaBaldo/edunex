...
### 🔑 Test Hesapları
Projeyi hızlıca deneyimlemek için aşağıdaki hesapları kullanabilirsiniz:
Admin için giriş: https://edunex-m252.onrender.com/admin/login.html
* **Admin Hesabı:** `admin@admin.com` / Şifre: `123456`

Kullanıcı için giriş: https://edunex-m252.onrender.com/auth/index.html
* **Eğitmen Hesabı:** `egitmen@admin.com` / Şifre: `123456`
* **Öğrenci Hesabı:** `ogrenci@admin.com` / Şifre: `123456`